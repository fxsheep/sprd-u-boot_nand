...
huamobile_cp8056_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_cp8056 huamobile sc8810

huamobile_8056c_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_8056c huamobile sc8810

huamobile_cp8076_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_cp8076 huamobile sc8810

huamobile_d58_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_d58 huamobile sc8810

huamobile_h1_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_h1 huamobile sc8810

huamobile_h2_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_h2 huamobile sc8810

huamobile_h3_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_h3 huamobile sc8810

huamobile_h4_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_h4 huamobile sc8810

huamobile_h5_config	: unconfig
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@$(MKCONFIG) $@ arm armv7 huamobile_h5 huamobile sc8810

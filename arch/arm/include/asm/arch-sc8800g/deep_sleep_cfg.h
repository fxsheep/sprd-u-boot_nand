 ...
 ******************************************************************************/
#ifndef _DEEP_SLEEP_CFG_H_
#define _DEEP_SLEEP_CFG_H_
...
//  Note:
/*****************************************************************************/
PUBLIC SLP_TYPE_E  Slp_Get_Slp_Status (void);
/*****************************************************************************/
//  Function name:  Slp_Reg_Cfg
...
//  Note:
/*****************************************************************************/
PUBLIC void Slp_Reg_Cfg (SLP_TYPE_E slp_type,SLP_CFG_TYPE_E cfg_type);

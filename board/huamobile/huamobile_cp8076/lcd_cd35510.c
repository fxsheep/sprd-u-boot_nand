...
//AVDD ratio
send_cmd(0xB600); send_data(0x44);
send_cmd( 0xB601); send_data(0x44);
send_cmd( 0xB602); send_data(0x44);
//AVEE -5.5V
send_cmd( 0xB100); send_data(0x0A);
...
//VCL -2.5V
send_cmd( 0xB200); send_data(0x01);//0x00
send_cmd( 0xB201); send_data(0x01);//0x00
send_cmd( 0xB202); send_data(0x01);//0x00
//VCL ratio
send_cmd( 0xB800); send_data(0x34);//0x24
send_cmd( 0xB801); send_data(0x24);
send_cmd( 0xB802); send_data(0x24);
//VGH 15V (Free pump)
send_cmd( 0xBF00); send_data(0x01);

send_cmd( 0xB300); send_data(0x08);
...
//VGLX ratio
send_cmd( 0xBA00); send_data(0x04);//0x24
send_cmd( 0xBA01); send_data(0x04);//0x24
send_cmd( 0xBA02); send_data(0x04);//0x24
//VGMP/VGSP 5V/0V
...
send_cmd( 0xBE01); send_data(0x6A);//0x64//0x84
...
send_cmd( 0xD105); send_data(0x18);
send_cmd( 0xD106); send_data(0x00);
send_cmd( 0xD107); send_data(0x43);
send_cmd( 0xD108); send_data(0x00);
send_cmd( 0xD109); send_data(0x77);
send_cmd( 0xD10A); send_data(0x00);
send_cmd( 0xD10B); send_data(0xC4);
send_cmd( 0xD10C); send_data(0x01);
send_cmd( 0xD10D); send_data(0x08);
send_cmd( 0xD10E); send_data(0x01);
send_cmd( 0xD10F); send_data(0x52);
send_cmd( 0xD110); send_data(0x01);
send_cmd( 0xD111); send_data(0x81);
send_cmd( 0xD112); send_data(0x01);
send_cmd( 0xD113); send_data(0xBD);
send_cmd( 0xD114); send_data(0x01);
send_cmd( 0xD115); send_data(0xE7);
send_cmd( 0xD116); send_data(0x02);
send_cmd( 0xD117); send_data(0x20);
send_cmd( 0xD118); send_data(0x02);
send_cmd( 0xD119); send_data(0x4A);
send_cmd( 0xD11A); send_data(0x02);
send_cmd( 0xD11B); send_data(0x4B);
send_cmd( 0xD11C); send_data(0x02);
send_cmd( 0xD11D); send_data(0x70);
send_cmd( 0xD11E); send_data(0x02);
send_cmd( 0xD11F); send_data(0x96);
send_cmd( 0xD120); send_data(0x02);
send_cmd( 0xD121); send_data(0xAA);
send_cmd( 0xD122); send_data(0x02);
send_cmd( 0xD123); send_data(0xC3);
send_cmd( 0xD124); send_data(0x02);
send_cmd( 0xD125); send_data(0xD2);
send_cmd( 0xD126); send_data(0x02);
send_cmd( 0xD127); send_data(0xE5);
send_cmd( 0xD128); send_data(0x02);
send_cmd( 0xD129); send_data(0xF1);
send_cmd( 0xD12A); send_data(0x03);
send_cmd( 0xD12B); send_data(0x02);
send_cmd( 0xD12C); send_data(0x03);
send_cmd( 0xD12D); send_data(0x0F);
send_cmd( 0xD12E); send_data(0x03);
send_cmd( 0xD12F); send_data(0x23);
send_cmd( 0xD130); send_data(0x03);
send_cmd( 0xD131); send_data(0x54);
...
send_cmd( 0xD205); send_data(0x18);
send_cmd( 0xD206); send_data(0x00);
send_cmd( 0xD207); send_data(0x43);
send_cmd( 0xD208); send_data(0x00);
send_cmd( 0xD209); send_data(0x77);
send_cmd( 0xD20A); send_data(0x00);
send_cmd( 0xD20B); send_data(0xC4);
send_cmd( 0xD20C); send_data(0x01);
send_cmd( 0xD20D); send_data(0x08);
send_cmd( 0xD20E); send_data(0x01);
send_cmd( 0xD20F); send_data(0x52);
send_cmd( 0xD210); send_data(0x01);
send_cmd( 0xD211); send_data(0x81);
send_cmd( 0xD212); send_data(0x01);
send_cmd( 0xD213); send_data(0xBD);
send_cmd( 0xD214); send_data(0x01);
send_cmd( 0xD215); send_data(0xE7);
send_cmd( 0xD216); send_data(0x02);
send_cmd( 0xD217); send_data(0x20);
send_cmd( 0xD218); send_data(0x02);
send_cmd( 0xD219); send_data(0x4A);
send_cmd( 0xD21A); send_data(0x02);
send_cmd( 0xD21B); send_data(0x4B);
send_cmd( 0xD21C); send_data(0x02);
send_cmd( 0xD21D); send_data(0x70);
send_cmd( 0xD21E); send_data(0x02);
send_cmd( 0xD21F); send_data(0x96);
send_cmd( 0xD220); send_data(0x02);
send_cmd( 0xD221); send_data(0xAA);
send_cmd( 0xD222); send_data(0x02);
send_cmd( 0xD223); send_data(0xC3);
send_cmd( 0xD224); send_data(0x02);
send_cmd( 0xD225); send_data(0xD2);
send_cmd( 0xD226); send_data(0x02);
send_cmd( 0xD227); send_data(0xE5);
send_cmd( 0xD228); send_data(0x02);
send_cmd( 0xD229); send_data(0xF1);
send_cmd( 0xD22A); send_data(0x03);
send_cmd( 0xD22B); send_data(0x02);
send_cmd( 0xD22C); send_data(0x03);
send_cmd( 0xD22D); send_data(0x0F);
send_cmd( 0xD22E); send_data(0x03);
send_cmd( 0xD22F); send_data(0x23);
send_cmd( 0xD230); send_data(0x03);
send_cmd( 0xD231); send_data(0x54);
...
send_cmd( 0xD305); send_data(0x18);
send_cmd( 0xD306); send_data(0x00);
send_cmd( 0xD307); send_data(0x43);
send_cmd( 0xD308); send_data(0x00);
send_cmd( 0xD309); send_data(0x77);
send_cmd( 0xD30A); send_data(0x00);
send_cmd( 0xD30B); send_data(0xC4);
send_cmd( 0xD30C); send_data(0x01);
send_cmd( 0xD30D); send_data(0x08);
send_cmd( 0xD30E); send_data(0x01);
send_cmd( 0xD30F); send_data(0x52);
send_cmd( 0xD310); send_data(0x01);
send_cmd( 0xD311); send_data(0x81);
send_cmd( 0xD312); send_data(0x01);
send_cmd( 0xD313); send_data(0xBD);
send_cmd( 0xD314); send_data(0x01);
send_cmd( 0xD315); send_data(0xE7);
send_cmd( 0xD316); send_data(0x02);
send_cmd( 0xD317); send_data(0x20);
send_cmd( 0xD318); send_data(0x02);
send_cmd( 0xD319); send_data(0x4A);
send_cmd( 0xD31A); send_data(0x02);
send_cmd( 0xD31B); send_data(0x4B);
send_cmd( 0xD31C); send_data(0x02);
send_cmd( 0xD31D); send_data(0x70);
send_cmd( 0xD31E); send_data(0x02);
send_cmd( 0xD31F); send_data(0x96);
send_cmd( 0xD320); send_data(0x02);
send_cmd( 0xD321); send_data(0xAA);
send_cmd( 0xD322); send_data(0x02);
send_cmd( 0xD323); send_data(0xC3);
send_cmd( 0xD324); send_data(0x02);
send_cmd( 0xD325); send_data(0xD2);
send_cmd( 0xD326); send_data(0x02);
send_cmd( 0xD327); send_data(0xE5);
send_cmd( 0xD328); send_data(0x02);
send_cmd( 0xD329); send_data(0xF1);
send_cmd( 0xD32A); send_data(0x03);
send_cmd( 0xD32B); send_data(0x02);
send_cmd( 0xD32C); send_data(0x03);
send_cmd( 0xD32D); send_data(0x0F);
send_cmd( 0xD32E); send_data(0x03);
send_cmd( 0xD32F); send_data(0x23);
send_cmd( 0xD330); send_data(0x03);
send_cmd( 0xD331); send_data(0x54);
...
send_cmd( 0xD405); send_data(0x18);
send_cmd( 0xD406); send_data(0x00);
send_cmd( 0xD407); send_data(0x43);
send_cmd( 0xD408); send_data(0x00);
send_cmd( 0xD409); send_data(0x77);
send_cmd( 0xD40A); send_data(0x00);
send_cmd( 0xD40B); send_data(0xC4);
send_cmd( 0xD40C); send_data(0x01);
send_cmd( 0xD40D); send_data(0x08);
send_cmd( 0xD40E); send_data(0x01);
send_cmd( 0xD40F); send_data(0x52);
send_cmd( 0xD410); send_data(0x01);
send_cmd( 0xD411); send_data(0x81);
send_cmd( 0xD412); send_data(0x01);
send_cmd( 0xD413); send_data(0xBD);
send_cmd( 0xD414); send_data(0x01);
send_cmd( 0xD415); send_data(0xE7);
send_cmd( 0xD416); send_data(0x02);
send_cmd( 0xD417); send_data(0x20);
send_cmd( 0xD418); send_data(0x02);
send_cmd( 0xD419); send_data(0x4A);
send_cmd( 0xD41A); send_data(0x02);
send_cmd( 0xD41B); send_data(0x4B);
send_cmd( 0xD41C); send_data(0x02);
send_cmd( 0xD41D); send_data(0x70);
send_cmd( 0xD41E); send_data(0x02);
send_cmd( 0xD41F); send_data(0x96);
send_cmd( 0xD420); send_data(0x02);
send_cmd( 0xD421); send_data(0xAA);
send_cmd( 0xD422); send_data(0x02);
send_cmd( 0xD423); send_data(0xC3);
send_cmd( 0xD424); send_data(0x02);
send_cmd( 0xD425); send_data(0xD2);
send_cmd( 0xD426); send_data(0x02);
send_cmd( 0xD427); send_data(0xE5);
send_cmd( 0xD428); send_data(0x02);
send_cmd( 0xD429); send_data(0xF1);
send_cmd( 0xD42A); send_data(0x03);
send_cmd( 0xD42B); send_data(0x02);
send_cmd( 0xD42C); send_data(0x03);
send_cmd( 0xD42D); send_data(0x0F);
send_cmd( 0xD42E); send_data(0x03);
send_cmd( 0xD42F); send_data(0x23);
send_cmd( 0xD430); send_data(0x03);
send_cmd( 0xD431); send_data(0x54);
...
send_cmd( 0xD505); send_data(0x18);
send_cmd( 0xD506); send_data(0x00);
send_cmd( 0xD507); send_data(0x43);
send_cmd( 0xD508); send_data(0x00);
send_cmd( 0xD509); send_data(0x77);
send_cmd( 0xD50A); send_data(0x00);
send_cmd( 0xD50B); send_data(0xC4);
send_cmd( 0xD50C); send_data(0x01);
send_cmd( 0xD50D); send_data(0x08);
send_cmd( 0xD50E); send_data(0x01);
send_cmd( 0xD50F); send_data(0x52);
send_cmd( 0xD510); send_data(0x01);
send_cmd( 0xD511); send_data(0x81);
send_cmd( 0xD512); send_data(0x01);
send_cmd( 0xD513); send_data(0xBD);
send_cmd( 0xD514); send_data(0x01);
send_cmd( 0xD515); send_data(0xE7);
send_cmd( 0xD516); send_data(0x02);
send_cmd( 0xD517); send_data(0x20);
send_cmd( 0xD518); send_data(0x02);
send_cmd( 0xD519); send_data(0x4A);
send_cmd( 0xD51A); send_data(0x02);
send_cmd( 0xD51B); send_data(0x4B);
send_cmd( 0xD51C); send_data(0x02);
send_cmd( 0xD51D); send_data(0x70);
send_cmd( 0xD51E); send_data(0x02);
send_cmd( 0xD51F); send_data(0x96);
send_cmd( 0xD520); send_data(0x02);
send_cmd( 0xD521); send_data(0xAA);
send_cmd( 0xD522); send_data(0x02);
send_cmd( 0xD523); send_data(0xC3);
send_cmd( 0xD524); send_data(0x02);
send_cmd( 0xD525); send_data(0xD2);
send_cmd( 0xD526); send_data(0x02);
send_cmd( 0xD527); send_data(0xE5);
send_cmd( 0xD528); send_data(0x02);
send_cmd( 0xD529); send_data(0xF1);
send_cmd( 0xD52A); send_data(0x03);
send_cmd( 0xD52B); send_data(0x02);
send_cmd( 0xD52C); send_data(0x03);
send_cmd( 0xD52D); send_data(0x0F);
send_cmd( 0xD52E); send_data(0x03);
send_cmd( 0xD52F); send_data(0x23);
send_cmd( 0xD530); send_data(0x03);
send_cmd( 0xD531); send_data(0x54);
...
send_cmd( 0xD605); send_data(0x18);
send_cmd( 0xD606); send_data(0x00);
send_cmd( 0xD607); send_data(0x43);
send_cmd( 0xD608); send_data(0x00);
send_cmd( 0xD609); send_data(0x77);
send_cmd( 0xD60A); send_data(0x00);
send_cmd( 0xD60B); send_data(0xC4);
send_cmd( 0xD60C); send_data(0x01);
send_cmd( 0xD60D); send_data(0x08);
send_cmd( 0xD60E); send_data(0x01);
send_cmd( 0xD60F); send_data(0x52);
send_cmd( 0xD610); send_data(0x01);
send_cmd( 0xD611); send_data(0x81);
send_cmd( 0xD612); send_data(0x01);
send_cmd( 0xD613); send_data(0xBD);
send_cmd( 0xD614); send_data(0x01);
send_cmd( 0xD615); send_data(0xE7);
send_cmd( 0xD616); send_data(0x02);
send_cmd( 0xD617); send_data(0x20);
send_cmd( 0xD618); send_data(0x02);
send_cmd( 0xD619); send_data(0x4A);
send_cmd( 0xD61A); send_data(0x02);
send_cmd( 0xD61B); send_data(0x4B);
send_cmd( 0xD61C); send_data(0x02);
send_cmd( 0xD61D); send_data(0x70);
send_cmd( 0xD61E); send_data(0x02);
send_cmd( 0xD61F); send_data(0x96);
send_cmd( 0xD620); send_data(0x02);
send_cmd( 0xD621); send_data(0xAA);
send_cmd( 0xD622); send_data(0x02);
send_cmd( 0xD623); send_data(0xC3);
send_cmd( 0xD624); send_data(0x02);
send_cmd( 0xD625); send_data(0xD2);
send_cmd( 0xD626); send_data(0x02);
send_cmd( 0xD627); send_data(0xE5);
send_cmd( 0xD628); send_data(0x02);
send_cmd( 0xD629); send_data(0xF1);
send_cmd( 0xD62A); send_data(0x03);
send_cmd( 0xD62B); send_data(0x02);
send_cmd( 0xD62C); send_data(0x03);
send_cmd( 0xD62D); send_data(0x0F);
send_cmd( 0xD62E); send_data(0x03);
send_cmd( 0xD62F); send_data(0x23);
send_cmd( 0xD630); send_data(0x03);
send_cmd( 0xD631); send_data(0x54);
...
send_cmd( 0xBD01); send_data(0x90);
send_cmd( 0xBD02); send_data(0x1C);
send_cmd( 0xBD03); send_data(0x1C);
...
send_cmd(0x4401); send_data(0x7a); 
...
// for NT35510 +	CD3.97'  mipi
  ...
  send_cmd(0xB100); send_data(0x00); // Setting VGL_REG Voltage
  send_cmd(0xB101); send_data(0x00);
  send_cmd(0xB102); send_data(0x00);

  send_cmd(0xB700); send_data(0x34); // Setting VGL_REG Voltage
  send_cmd(0xB701); send_data(0x34);
  send_cmd(0xB702); send_data(0x34);
  ...
  send_cmd(0xB800); send_data(0x34); // Setting VGL_REG Voltage
  send_cmd(0xB801); send_data(0x34);
  send_cmd(0xB802); send_data(0x34);

//  send_cmd(0xBF00); send_data(0x01); // VGH Output Voltage

  send_cmd(0xB300); send_data(0x0F); // Setting VGL_REG Voltage
  ...
  send_cmd(0xBA00); send_data(0x34); // Setting VGL_REG Voltage
  send_cmd(0xBA01); send_data(0x34);
  send_cmd(0xBA02); send_data(0x34);

  send_cmd(0xBC00); send_data(0x00); // Setting VGL_REG Voltage
  send_cmd(0xBC01); send_data(0x9E);
  send_cmd(0xBC02); send_data(0x00);

  send_cmd(0xBD00); send_data(0x00); // Setting VGL_REG Voltage
  send_cmd(0xBD01); send_data(0x9E);
  send_cmd(0xBD02); send_data(0x00);

  send_cmd(0xBE00); send_data(0x00); // Setting VGL_REG Voltage
  send_cmd(0xBE01); send_data(0xA2); //vcom  7f
...
//printk("cj cd35510_enter_sleep = %d \n",is_sleep);
	...
	if(is_sleep) {
		...
		//VCOM -1.325V
		send_cmd(0xBE00);send_data(0x00);
		send_cmd(0xBE01);send_data(vcom);
		printk("====================%s: vcom=0x%x\n\n", __func__, vcom);
		vcom+=2;
		*/
...
//for hengkaihui
static struct timing_mcu lcd_cd35510_timing_hkh[] = {
...
//for chuangshi
static struct timing_mcu lcd_cd35510_timing_cs[] = {
	[LCD_REGISTER_TIMING] = {					 // read/write register timing
			.rcss = 25,//15,  // 15ns
			.rlpw = 90,//60,90	70
			.rhpw = 90,//60,90	70
...
static struct info_mcu lcd_cd35510_info_hkh = {
	.bus_mode = LCD_BUS_8080,
	.bus_width = 24,
	.timing = lcd_cd35510_timing_hkh,
	.ops = NULL,
};

static struct info_mcu lcd_cd35510_info_cs = {
	.bus_mode = LCD_BUS_8080,
	.bus_width = 24,
	.timing = lcd_cd35510_timing_cs,
	.ops = NULL,
};


struct lcd_spec lcd_panel_cd35510_hkh = {
	.width = 480,
	.height = 800,
	.mode = LCD_MODE_MCU,
	.direction = LCD_DIRECT_NORMAL,
	.info = {.mcu = &lcd_cd35510_info_hkh},
	.ops = &lcd_cd35510_operations,
};

struct lcd_spec lcd_panel_cd35510_cs = {
	.width = 480,
	.height = 800,
	.mode = LCD_MODE_MCU,
	.direction = LCD_DIRECT_NORMAL,
	.info = {.mcu = &lcd_cd35510_info_cs},
	.ops = &lcd_cd35510_operations,
};

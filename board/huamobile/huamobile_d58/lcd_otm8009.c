...
static int32_t otm8009_init(struct lcd_spec *self)
{
	...
	if(!ret){
		...
		send_cmd(0xD800); send_data(0x6F);
		send_cmd(0xD801); send_data(0x6F);
		...
		send_cmd(0xD900); send_data(0x30);

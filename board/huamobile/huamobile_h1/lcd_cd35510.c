...
//VCL -2.5V
send_cmd( 0xB200); send_data(0x00);//0x01
send_cmd( 0xB201); send_data(0x00);//0x01
send_cmd( 0xB202); send_data(0x00);//0x01
//VCL ratio
...
send_cmd( 0xBC00); send_data(0x02);//0x00
send_cmd( 0xBC01); send_data(0x02);//0x00
send_cmd( 0xBC02); send_data(0x02);//0x00
//#Timing control = T1A

...

{
		...
		send_cmd(0xc0b4); send_data(0x10);    //10  2+1DOT   50  COLUMN
		...
		send_cmd(0xc480); send_data(0x10);
		send_cmd(0xc481); send_data(0x07);

		send_cmd(0xd800); send_data(0x77);
		send_cmd(0xd801); send_data(0x77);

//		send_cmd(0xd900); send_data(0x6f);   //VCOM  5f 3d 4f 6f     97 gamma old
//           send_cmd(0xd900); send_data(0x61); //97 gamma new
              send_cmd(0xd900); send_data(0x5c);     //  77 gamma 1.8 & gamma 2.0 & gamma 2.2
//           send_cmd(0xd900); send_data(0x5a);    // 67 gamma 2.2
//           send_cmd(0xd900); send_data(0x58);       //57 gamma2.2
		send_cmd(0xc181); send_data(0x55);   //RATE   60
		...
		send_cmd(0xcbe0); send_data(0x05);
...
// 97 gammer new
		...
		send_cmd(0xE101); send_data(0x02);
		send_cmd(0xE102); send_data(0x06);
		send_cmd(0xE103); send_data(0x0d);
		send_cmd(0xE104); send_data(0x0a);
		send_cmd(0xE105); send_data(0x1f);
		send_cmd(0xE106); send_data(0x0f);
		send_cmd(0xE107); send_data(0x0f);
		send_cmd(0xE108); send_data(0x00);
		send_cmd(0xE109); send_data(0x02);
		send_cmd(0xE10a); send_data(0x00);
		send_cmd(0xE10b); send_data(0x05);
		send_cmd(0xE10c); send_data(0x0c);
		send_cmd(0xE10d); send_data(0x1f);
		send_cmd(0xE10e); send_data(0x1c);
		send_cmd(0xE10f); send_data(0x12);
              send_cmd(0xE200); send_data(0x00);

              send_cmd(0xE201); send_data(0x02);
		send_cmd(0xE202); send_data(0x06);
		send_cmd(0xE203); send_data(0x0d);
		send_cmd(0xE204); send_data(0x0a);
		send_cmd(0xE205); send_data(0x1f);
		send_cmd(0xE206); send_data(0x0f);
		send_cmd(0xE207); send_data(0x0f);
		send_cmd(0xE208); send_data(0x00);
		send_cmd(0xE209); send_data(0x02);
		send_cmd(0xE20a); send_data(0x01);
		send_cmd(0xE20b); send_data(0x05);
		send_cmd(0xE20c); send_data(0x0c);
		send_cmd(0xE20d); send_data(0x1e);
		send_cmd(0xE20e); send_data(0x1b);
		send_cmd(0xE20f); send_data(0x12);
            ...
            //Gamma2.4    77
              ...
              send_cmd(0xE100); send_data(0x0a);
		send_cmd(0xE101); send_data(0x0b);
		send_cmd(0xE102); send_data(0x0e);
		send_cmd(0xE103); send_data(0x0d);
		send_cmd(0xE104); send_data(0x07);
		send_cmd(0xE105); send_data(0x1a);
		send_cmd(0xE106); send_data(0x0e);
		send_cmd(0xE107); send_data(0x0d);
		send_cmd(0xE108); send_data(0x01);
		send_cmd(0xE109); send_data(0x04);
		send_cmd(0xE10a); send_data(0x04);
		send_cmd(0xE10b); send_data(0x06);
		send_cmd(0xE10c); send_data(0x0d);
		send_cmd(0xE10d); send_data(0x24);
		send_cmd(0xE10e); send_data(0x21);
		send_cmd(0xE10f); send_data(0x12);



              send_cmd(0xE200); send_data(0x0a);
              send_cmd(0xE201); send_data(0x0b);
		send_cmd(0xE202); send_data(0x0e);
		send_cmd(0xE203); send_data(0x0d);
		send_cmd(0xE204); send_data(0x07);
		send_cmd(0xE205); send_data(0x1a);
		send_cmd(0xE206); send_data(0x0d);
		send_cmd(0xE207); send_data(0x0d);
		send_cmd(0xE208); send_data(0x01);
		send_cmd(0xE209); send_data(0x04);
		send_cmd(0xE20a); send_data(0x03);
		send_cmd(0xE20b); send_data(0x06);
		send_cmd(0xE20c); send_data(0x0d);
		send_cmd(0xE20d); send_data(0x24);
		send_cmd(0xE20e); send_data(0x20);
		send_cmd(0xE20f); send_data(0x12);
#endif 
		...
		//Gamma2.2    77
              ...
              send_cmd(0xE100); send_data(0x00);
		send_cmd(0xE101); send_data(0x05);
		send_cmd(0xE102); send_data(0x0f);
		send_cmd(0xE103); send_data(0x0f);
		send_cmd(0xE104); send_data(0x0a);
		send_cmd(0xE105); send_data(0x1f);
		send_cmd(0xE106); send_data(0x0f);
		send_cmd(0xE107); send_data(0x0f);
		...
		send_cmd(0xE10a); send_data(0x01);
		send_cmd(0xE10b); send_data(0x07);
		send_cmd(0xE10c); send_data(0x0e);
		send_cmd(0xE10d); send_data(0x22);
		send_cmd(0xE10e); send_data(0x1f);
		send_cmd(0xE10f); send_data(0x12);
		...
		send_cmd(0xE202); send_data(0x0f);
		send_cmd(0xE203); send_data(0x0f);
		send_cmd(0xE204); send_data(0x0a);
		send_cmd(0xE205); send_data(0x1f);
		send_cmd(0xE206); send_data(0x0f);
		send_cmd(0xE207); send_data(0x0e);
		send_cmd(0xE208); send_data(0x00);
		send_cmd(0xE209); send_data(0x05);
		send_cmd(0xE20a); send_data(0x01);
		send_cmd(0xE20b); send_data(0x07);
		send_cmd(0xE20c); send_data(0x0e);
...
//Gamma2.0   77
              ...
              send_cmd(0xE100); send_data(0x00);
		send_cmd(0xE101); send_data(0x08);
		send_cmd(0xE102); send_data(0x13);
		send_cmd(0xE103); send_data(0x11);
		send_cmd(0xE104); send_data(0x0c);
		send_cmd(0xE105); send_data(0x1f);
		send_cmd(0xE106); send_data(0x0f);
		send_cmd(0xE107); send_data(0x0f);
		send_cmd(0xE108); send_data(0x00);
		...
		send_cmd(0xE10d); send_data(0x21);
		...
		send_cmd(0xE10f); send_data(0x12);
              ...
              send_cmd(0xE200); send_data(0x00);
              send_cmd(0xE201); send_data(0x07);
		send_cmd(0xE202); send_data(0x13);
		send_cmd(0xE203); send_data(0x11);
		send_cmd(0xE204); send_data(0x0c);
		send_cmd(0xE205); send_data(0x1f);
		send_cmd(0xE206); send_data(0x0f);
		send_cmd(0xE207); send_data(0x0e);
		send_cmd(0xE208); send_data(0x00);
		...
		send_cmd(0xE20d); send_data(0x20);
		send_cmd(0xE20e); send_data(0x1e);
		send_cmd(0xE20f); send_data(0x12);
#endif
...
//Gamma1.8   77
              ...
              send_cmd(0xE100); send_data(0x0a);
		send_cmd(0xE101); send_data(0x11);
		send_cmd(0xE102); send_data(0x19);
		send_cmd(0xE103); send_data(0x11);
		send_cmd(0xE104); send_data(0x0b);
		send_cmd(0xE105); send_data(0x1b);
		send_cmd(0xE106); send_data(0x0e);
		send_cmd(0xE107); send_data(0x0d);
		send_cmd(0xE108); send_data(0x01);
		send_cmd(0xE109); send_data(0x04);
		...
		send_cmd(0xE10b); send_data(0x06);
		send_cmd(0xE10c); send_data(0x0e);
		send_cmd(0xE10d); send_data(0x23);
		send_cmd(0xE10e); send_data(0x1f);
		send_cmd(0xE10f); send_data(0x12);
              ...
              send_cmd(0xE200); send_data(0x0a);
              send_cmd(0xE201); send_data(0x10);
		send_cmd(0xE202); send_data(0x19);
		send_cmd(0xE203); send_data(0x11);
		send_cmd(0xE204); send_data(0x0b);
		send_cmd(0xE205); send_data(0x1b);
		send_cmd(0xE206); send_data(0x0d);
		send_cmd(0xE207); send_data(0x0d);
		send_cmd(0xE208); send_data(0x01);
		send_cmd(0xE209); send_data(0x04);
		send_cmd(0xE20a); send_data(0x04);
		send_cmd(0xE20b); send_data(0x06);
		send_cmd(0xE20c); send_data(0x0d);
		send_cmd(0xE20d); send_data(0x22);
		send_cmd(0xE20e); send_data(0x1f);
		send_cmd(0xE20f); send_data(0x12);
#endif
...
//Gamma2.2        67
              ...
              send_cmd(0xE100); send_data(0x0a);
		send_cmd(0xE101); send_data(0x0c);
		send_cmd(0xE102); send_data(0x12);
		send_cmd(0xE103); send_data(0x11);
		send_cmd(0xE104); send_data(0x0b);
		send_cmd(0xE105); send_data(0x1c);
		send_cmd(0xE106); send_data(0x0e);
		send_cmd(0xE107); send_data(0x0d);
		send_cmd(0xE108); send_data(0x01);
		send_cmd(0xE109); send_data(0x05);
		send_cmd(0xE10a); send_data(0x03);
		send_cmd(0xE10b); send_data(0x08);
		send_cmd(0xE10c); send_data(0x0f);
		send_cmd(0xE10d); send_data(0x23);
		send_cmd(0xE10e); send_data(0x1f);
		send_cmd(0xE10f); send_data(0x12);
              ...
              send_cmd(0xE200); send_data(0x0a);
              send_cmd(0xE201); send_data(0x0c);
		send_cmd(0xE202); send_data(0x12);
		send_cmd(0xE203); send_data(0x11);
		send_cmd(0xE204); send_data(0x0b);
		send_cmd(0xE205); send_data(0x1c);
		send_cmd(0xE206); send_data(0x0e);
		send_cmd(0xE207); send_data(0x0d);
		send_cmd(0xE208); send_data(0x01);
		send_cmd(0xE209); send_data(0x05);
		send_cmd(0xE20a); send_data(0x02);
...
//Gamma2.2         57
              send_cmd(0xE100); send_data(0x0a);
		send_cmd(0xE101); send_data(0x0b);
		send_cmd(0xE102); send_data(0x10);
		send_cmd(0xE103); send_data(0x0f);
		send_cmd(0xE104); send_data(0x09);
		send_cmd(0xE105); send_data(0x1a);
		send_cmd(0xE106); send_data(0x0e);
		send_cmd(0xE107); send_data(0x0d);
		send_cmd(0xE108); send_data(0x01);
		...
		send_cmd(0xE10f); send_data(0x12);
              ...
              send_cmd(0xE200); send_data(0x0a);
              send_cmd(0xE201); send_data(0x0b);
		send_cmd(0xE202); send_data(0x10);
		send_cmd(0xE203); send_data(0x0f);
		send_cmd(0xE204); send_data(0x09);
		send_cmd(0xE205); send_data(0x1a);
		send_cmd(0xE206); send_data(0x0d);
		send_cmd(0xE207); send_data(0x0d);
		send_cmd(0xE208); send_data(0x01);
		...
		send_cmd(0x3500);send_data(0x00); 
		send_cmd(0x4400); send_data(0x01); 
		send_cmd(0x4401); send_data(0x90); //
		//send_cmd(0x3600);send_data(0x08); 
		send_cmd(0x1100); 
	    	 LCD_DelayMS(150);
		send_cmd(0x2900); 
		LCD_DelayMS(150);
